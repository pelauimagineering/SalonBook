...
<br/>
<br/>
<h3>The deposit for your appointment has been accepted.<br/><br/> <?php echo "$this->stylist_name" ?> is looking forward to seeing you on <?php echo $prettyDate ?> at <?php echo "$prettyTime" ?>.</h3>
